...
const AandD = React.createClass({
  ...
  render() {
    ...
    return (
       ...
       <ListItem primaryText="今日数据" leftIcon={<SettingsIcon/>} onTouchTap={this.refresh.bind(this, this.state.jumpuser)}/>
        <ListItem primaryText="运动圈" leftIcon={<UploadIcon/>} onTouchTap={this.handleUploadOpen} id="uploadData"/>


      <Link to="/stats" style={{ textDecoration: 'none' }}>  <ListItem primaryText="统计分析" leftIcon={<StatsIcon/>} onTouchTap={this.handleClose} /></Link>
<Link to="/postmanage" style={{ textDecoration: 'none' }}>   <ListItem primaryText="个人主页" leftIcon={<PostIcon/>} /></Link>
        </List>
