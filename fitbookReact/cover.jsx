...
const Cover = React.createClass({
    ...
    confirmModify(){
        ...
        var url="http://localhost/updateuser.php?ssid=";
        url+=getCookie("ssid");
        url+="&name=";
        url+=name;
        url+="&gender=";
    ...
    handleAddandDel(isadd){
        ...
        var url="http://localhost/friendadddel.php?ssid=";
        url+=getCookie("ssid");
        url+="&reply=";
        url+=isadd;
        url+="&friend=";
    ...
    uploadavatar(){
        var url="http://localhost/avataruploader.php?ssid=";
        url+=getCookie("ssid");
    ...
    uploadcover(){
        var url="http://localhost/coveruploader.php?ssid=";
        url+=getCookie("ssid");
    ...
    initData(){
        ...
        var url="http://localhost/leftinfogetter.php?ssid=";
        url+=getCookie("ssid");
        url+="&username=";
        url+=this.state.username;
